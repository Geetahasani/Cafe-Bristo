...
const Navbar = () => {
  ...
  const [open, setOpen] = useState(false); // <-- Fixed 'setOpen' undefined error

  return (
    <div>
      <header className="relative bg-white">
        <p className="flex h-10 items-center justify-center bg-red-300 px-4 text-sm font-medium text-white-700 sm:px-6 lg:px-8" 
           style={{ backgroundColor: mode === 'dark' ? 'rgb(62 64 66)' : '', color: mode === 'dark' ? 'white' : '', }}>
          Get free delivery on orders over ₹300
        </p>

        <nav aria-label="Top" className="bg-gray-200 px-4 sm:px-6 lg:px-8 shadow-xl" 
             style={{ backgroundColor: mode === 'dark' ? '#282c34' : '', color: mode === 'dark' ? 'white' : '', }}>
          <div className="">
            <div className="flex h-16 items-center">
              {/* Fixed 'setOpen' not defined */}
              <button
                type="button"
              ...
              >
                ...
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" 
                     className="w-6 h-6"> {/* <-- Fixed className */}
              ...
              <div className="ml-4 flex lg:ml-0">
                <Link to={'/'} className='flex'>
                  <h1 className=' text-2xl font-bold text-black px-2 py-1 rounded' 
                      style={{ color: mode === 'dark' ? 'white' : '', }}>Cafe-Bristo</h1>
                </Link>
              </div>
              ...
              <div className="ml-auto flex items-center">
                ...
                {/* <div className="hidden lg:ml-8 lg:flex">
                  <a href="#" className="flex items-center text-gray-700">
                    <img src="https://ecommerce-sk.vercel.app/img/indiaflag.png" alt=""
                ...
                {/* Theme Toggle (Fixed incorrect ternary logic) */}
                ...
                <div className="ml-4 flow-root lg:ml-6">
                  <Link to={'/cart'} className="group -m-2 flex items-center p-2" 
                    ...
                    <span className="ml-2 text-sm font-medium text-gray-700 group-" 
                          style={{ color: mode === 'dark' ? 'white' : '', }}>0</span>
